...
found](reference/figures/ref_id_locations.png) If you know the reference
IDs of the references you are interested in, you can use
[`search_references_by_id()`](https://doi-nps.github.io/NPSdatastore/reference/search_references_by_id.md)
to retrieve detailed information about them. This returns a nested list
whose names are the reference IDs. If
[`search_references_by_id()`](https://doi-nps.github.io/NPSdatastore/reference/search_references_by_id.md)
isn’t able to locate some references, it will throw a warning. If it
isn’t able to locate any references, it will throw an error.
